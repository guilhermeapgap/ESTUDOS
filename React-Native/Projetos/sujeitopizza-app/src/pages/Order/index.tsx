...
export default function Order(){
    ...
    const [categorySelected, setCategorySeleced] = useState<CategoryProps | undefined>()
    ...
    useEffect(() =>{
        async function loadinfo(){
            ...
            setCategorySeleced(response.data[0])
        }
    ...
    //adicionnando um produto nessa mesa
