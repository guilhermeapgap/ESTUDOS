...
do{        
    ...
    Lista* NovoElemento;    NovoElemento = (struct Lista*) malloc( sizeof(struct Lista)); //  aloca espaço para um bloco       
    ...
    if (Head == NULL) //se  nulo insere na primeira posição
        {        
            Head = NovoElemento;       
            Head->prox = NULL;    }    
        else    {//move o head para o proximo e inserir  o novo na primeira prosição        
        ...
        ElementoVarredura = (st ruct Li sta*)malloc (sizeof(struct Lista));
